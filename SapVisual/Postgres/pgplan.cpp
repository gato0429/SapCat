...
bool PgPlan::Borrar(Plan valor)
{
    QSqlQuery query;

    bool flag=query.exec("DELETE FROM plan WHERE codigo='"+valor.getCodigo()+"'");
...
bool PgPlan::Insertar(Plan valor)
{
    QSqlQuery query;
      query.prepare("INSERT INTO plan("
...
bool PgPlan::Actualizar(Plan Antiguo, Plan Nuevo)
{
    QSqlQuery query;

    QString consulta;
    consulta="UPDATE plan SET ";
...
Plan PgPlan::Buscar(Plan valor)
{
    QString consulta;

        consulta="SELECT codigo, nombre, codigo_imagen, ruta_img "
                "FROM vista_detalle_plan WHERE ";
...
QMap<QString, ObjetoMaestro *> *PgPlan::BuscarMapa(ObjetoMaestro *valor, QString Extra, CONSULTA Tipo)
{
...
qint64 PgPlan::Contar()
{
    QString consulta="SELECT count(*) FROM plan";
    qint64 num=0;
...
qint64 PgPlan::ContarConsulta(ObjetoMaestro *valor)
{
    Plan* val=(Plan*)(valor);
    QString consulta;
...
QSqlQueryModel *PgPlan::BuscarTabla(Plan valor, QString Extra, CONSULTA tipo)
{
    QString consulta;
...
QMap<QString, ObjetoMaestro *> *PgPlan::BuscarClave()
{
    QString consulta;

        consulta="SELECT codigo, nombre, codigo_imagen, ruta_img "
                "FROM vista_detalle_plan order by nombre asc";
